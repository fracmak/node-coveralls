...
var getBaseOptions = function(cb){
  ...
  */
  ...
  if (process.env.JENKINS_URL){
    ...
    git_commit = process.env.ghprbActualCommit || process.env.GIT_COMMIT;
    git_branch = process.env.ghprbSourceBranch || process.env.GIT_BRANCH.replace('origin/', '');
  }
  ...
  options.parallel = process.env.COVERALLS_PARALLEL;
